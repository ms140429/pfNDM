...
#ifndef AI_NETWORK_FE_H
#define AI_NETWORK_FE_H
#pragma once

#include "network_fe_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_FE_MODEL_NAME          "network_fe"
#define AI_NETWORK_FE_ORIGIN_MODEL_NAME   "kmodel_2"

/******************************************************************************/
#define AI_NETWORK_FE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_FE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_FE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_FE_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_FE_IN \
  ai_network_fe_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_FE_IN_SIZE { \
  AI_NETWORK_FE_IN_1_SIZE, \
}
#define AI_NETWORK_FE_IN_SIZE_BYTES { \
  AI_NETWORK_FE_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_FE_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_FE_IN_1_HEIGHT      (16)
#define AI_NETWORK_FE_IN_1_CHANNEL     (4)
#define AI_NETWORK_FE_IN_1_SIZE        (16 * 4)
#define AI_NETWORK_FE_IN_1_SIZE_BYTES  (256)

/******************************************************************************/
#define AI_NETWORK_FE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_FE_OUT \
  ai_network_fe_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_FE_OUT_SIZE { \
  AI_NETWORK_FE_OUT_1_SIZE, \
}
#define AI_NETWORK_FE_OUT_SIZE_BYTES { \
  AI_NETWORK_FE_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_FE_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_FE_OUT_1_HEIGHT      (14)
#define AI_NETWORK_FE_OUT_1_CHANNEL     (4)
#define AI_NETWORK_FE_OUT_1_SIZE        (14 * 4)
#define AI_NETWORK_FE_OUT_1_SIZE_BYTES  (224)

/******************************************************************************/
#define AI_NETWORK_FE_N_NODES (6)
 ...
 * @ref ai_network_fe_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_fe_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_fe_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_fe_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_FE_*
 * defines into file @ref network_fe.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_fe_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_FE_H */
