...
#ifndef AI_NETWORK_FX_H
#define AI_NETWORK_FX_H
#pragma once

#include "network_fx_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_FX_MODEL_NAME          "network_fx"
#define AI_NETWORK_FX_ORIGIN_MODEL_NAME   "fx"

/******************************************************************************/
#define AI_NETWORK_FX_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_FX_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_FX_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_FX_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_FX_IN \
  ai_network_fx_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_FX_IN_SIZE { \
  AI_NETWORK_FX_IN_1_SIZE, \
}
#define AI_NETWORK_FX_IN_SIZE_BYTES { \
  AI_NETWORK_FX_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_FX_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_FX_IN_1_CHANNEL     (48)
#define AI_NETWORK_FX_IN_1_SIZE        (48)
#define AI_NETWORK_FX_IN_1_SIZE_BYTES  (192)

/******************************************************************************/
#define AI_NETWORK_FX_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_FX_OUT \
  ai_network_fx_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_FX_OUT_SIZE { \
  AI_NETWORK_FX_OUT_1_SIZE, \
}
#define AI_NETWORK_FX_OUT_SIZE_BYTES { \
  AI_NETWORK_FX_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_FX_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_FX_OUT_1_CHANNEL     (48)
#define AI_NETWORK_FX_OUT_1_SIZE        (48)
#define AI_NETWORK_FX_OUT_1_SIZE_BYTES  (192)

/******************************************************************************/
#define AI_NETWORK_FX_N_NODES (1)
 ...
 * @ref ai_network_fx_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_fx_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_fx_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_fx_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_FX_*
 * defines into file @ref network_fx.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_fx_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_FX_H */
