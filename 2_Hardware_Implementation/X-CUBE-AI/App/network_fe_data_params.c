...
/**  Activations Section  ****************************************************/
ai_handle g_network_fe_activations_table[1 + 2] = {
...
/**  Weights Section  ********************************************************/
AI_ALIGNED(32)
const ai_u64 s_network_fe_weights_array_u64[52] = {
...
ai_handle g_network_fe_weights_table[1 + 2] = {
  AI_HANDLE_PTR(AI_MAGIC_MARKER),
  AI_HANDLE_PTR(s_network_fe_weights_array_u64),
  AI_HANDLE_PTR(AI_MAGIC_MARKER),
};
