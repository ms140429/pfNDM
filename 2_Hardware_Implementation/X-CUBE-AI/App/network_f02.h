...
#ifndef AI_NETWORK_F02_H
#define AI_NETWORK_F02_H
#pragma once

#include "network_f02_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_F02_MODEL_NAME          "network_f02"
#define AI_NETWORK_F02_ORIGIN_MODEL_NAME   "kmodel_2"

/******************************************************************************/
#define AI_NETWORK_F02_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_F02_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_F02_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_F02_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_F02_IN \
  ai_network_f02_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_F02_IN_SIZE { \
  AI_NETWORK_F02_IN_1_SIZE, \
}
#define AI_NETWORK_F02_IN_SIZE_BYTES { \
  AI_NETWORK_F02_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_F02_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_F02_IN_1_HEIGHT      (4)
#define AI_NETWORK_F02_IN_1_CHANNEL     (14)
#define AI_NETWORK_F02_IN_1_SIZE        (4 * 14)
#define AI_NETWORK_F02_IN_1_SIZE_BYTES  (224)

/******************************************************************************/
#define AI_NETWORK_F02_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_F02_OUT \
  ai_network_f02_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_F02_OUT_SIZE { \
  AI_NETWORK_F02_OUT_1_SIZE, \
}
#define AI_NETWORK_F02_OUT_SIZE_BYTES { \
  AI_NETWORK_F02_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_F02_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_F02_OUT_1_CHANNEL     (48)
#define AI_NETWORK_F02_OUT_1_SIZE        (48)
#define AI_NETWORK_F02_OUT_1_SIZE_BYTES  (192)

/******************************************************************************/
#define AI_NETWORK_F02_N_NODES (1)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_f02
 ...
 * @ref ai_network_f02_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_f02_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_f02_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_f02_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_F02_*
 * defines into file @ref network_f02.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_f02_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_F02_H */
