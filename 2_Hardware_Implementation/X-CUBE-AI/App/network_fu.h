...
#ifndef AI_NETWORK_FU_H
#define AI_NETWORK_FU_H
#pragma once

#include "network_fu_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_FU_MODEL_NAME          "network_fu"
#define AI_NETWORK_FU_ORIGIN_MODEL_NAME   "fu"

/******************************************************************************/
#define AI_NETWORK_FU_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_FU_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_FU_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_FU_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_FU_IN \
  ai_network_fu_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_FU_IN_SIZE { \
  AI_NETWORK_FU_IN_1_SIZE, \
}
#define AI_NETWORK_FU_IN_SIZE_BYTES { \
  AI_NETWORK_FU_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_FU_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_FU_IN_1_CHANNEL     (10)
#define AI_NETWORK_FU_IN_1_SIZE        (10)
#define AI_NETWORK_FU_IN_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_NETWORK_FU_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_FU_OUT \
  ai_network_fu_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_FU_OUT_SIZE { \
  AI_NETWORK_FU_OUT_1_SIZE, \
}
#define AI_NETWORK_FU_OUT_SIZE_BYTES { \
  AI_NETWORK_FU_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_FU_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_FU_OUT_1_CHANNEL     (48)
#define AI_NETWORK_FU_OUT_1_SIZE        (48)
#define AI_NETWORK_FU_OUT_1_SIZE_BYTES  (192)

/******************************************************************************/
#define AI_NETWORK_FU_N_NODES (19)
 ...
 * @ref ai_network_fu_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_fu_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_fu_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_fu_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_FU_*
 * defines into file @ref network_fu.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_fu_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_FU_H */
