...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "kmodel_2"
...
#define AI_NETWORK_IN_1_HEIGHT      (4)
#define AI_NETWORK_IN_1_CHANNEL     (14)
#define AI_NETWORK_IN_1_SIZE        (4 * 14)
#define AI_NETWORK_IN_1_SIZE_BYTES  (224)
...
#define AI_NETWORK_OUT_1_CHANNEL     (48)
#define AI_NETWORK_OUT_1_SIZE        (48)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (192)
